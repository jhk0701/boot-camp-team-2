...
> 원래는 젤리가 고정된 상태이기 때문에 충돌 후 물리 연산에 따라서 반사각으로 튕겨 나오지만<br>
...
> 밀리는 젤리와 충돌 시 도로 튕겨나가는 기능을 직접 구현했습니다.<br>
> <img src="https://github.com/user-attachments/assets/6d3c278e-c5ca-4974-ad86-6efe0c4f6be3"><br><br>
> 게임 오브젝트들이 충돌해서 이벤트가 발생하고<br>
> 충돌 이벤트의 매개변수로 들어오는 collision에는 충돌에 대한 여러 정보가 담겨져 있었습니다.<br>
> 그 정보 중에는 충돌이 일어난 지점도 있었습니다.<br><br>
> 공의 위치와 충돌이 일어난 지점을 이용하면 공을 튕겨내는 것도 가능하다고 생각했습니다.<br>
> 공의 위치 - 충돌 지점을 이용하면 들어온 방향의 반대 방향을 구할 수 있었습니다.<br>
> 그리고 이렇게 방향을 알 수 있다면 원하는 방법으로 공을 튕겨낼 수 있었습니다.<br><br>
> 위에서 보는 것과 같이 정확하게 반사각으로 튕겨내지 않고 있는데<br>
> 그 이유는 경우에 따라서 공이 튕겨나면서 패들과 수평하게 움직이는 것을 확인했습니다.<br>
> 이때 공은 영원히 패들과 닿지 않는 또 다른 버그가 생겨서 이를 방지하고자<br>
> 대략적인 방향을 알면 그 방향으로 절댓값 (1,1)의 속도로 튕겨내도록 구현했습니다.
